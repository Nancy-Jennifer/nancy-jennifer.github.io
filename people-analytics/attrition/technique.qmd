...
## Chargement du jeu de données (avec mode dégradé)
...
if data_path is None:
    ...
    print(
        ...
        "→ Mode dégradé activé : les cellules dépendant du dataset sont ignorées ici.\n"
...
## Vérifications rapides (type & valeurs)
...
### H5 – Ancienneté × Heures supplémentaires × Départ
...
#### Heures sup par tranches d’ancienneté
...
if not DATA_AVAILABLE:
    ...
    print(sorted(f for f in os.listdir(OUTPUT_DIR) if f.lower().endswith(".png")))
```
