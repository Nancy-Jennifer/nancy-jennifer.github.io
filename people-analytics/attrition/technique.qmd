...
```{python}
# Chemin officiel du fichier de données (depuis la racine du projet Quarto)
data_path = "people-analytics/data/WA_Fn-UseC_-HR-Employee-Attrition.csv"

if not os.path.exists(data_path):
    raise FileNotFoundError(
        f"Le fichier '{data_path}' est introuvable.\n"
        "→ Vérifie qu'il est bien présent dans le dépôt GitHub."
    )
