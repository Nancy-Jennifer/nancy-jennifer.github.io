...
> ✅ **Sortie attendue étape 3 :** 
colonnes normalisées `z_dl,z_ul,z_c4g,z_c5g,z_lat,z_css,z_cset,z_drop`  
...
> ✅ **Sorties attendues étape 7 :** 
`outputs/p2/panel_qos_scored.csv`, `outputs/p2/qos_weights_meta.csv`
<!-- ===== SECTION 3.7 : FIN ===== -->
