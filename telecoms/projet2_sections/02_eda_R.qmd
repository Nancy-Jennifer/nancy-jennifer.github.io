...
L’objectif de cette section est de replacer les performances ARCEP 2024 dans un cadre international, en utilisant les jeux de données UIT prétraités.
...
ggplot(internet_use_plot,
  ...
  labs(
    ...
    subtitle = "Comparaison France vs régions mondiales – ITU 2024",
    x = NULL,
    y = "% de la population"
  ) +
  guides(fill = "none")
...
```{r itu-mbb-plot, fig.cap="Abonnements mobile broadband – France vs régions mondiales (UIT 2024)."}
...
ggplot(mbb_plot,
  ...
  labs(
    ...
    subtitle = "France vs régions – ITU 2024",
    x = NULL,
