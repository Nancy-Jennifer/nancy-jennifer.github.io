...
# Coalescence et choix robuste de colonnes
`%||%` <- function(a, b) {
...
# Si malgré tout kpi absent (datasets vides), le créer pour éviter erreurs
if (!"kpi" %in% names(voix_raw)) voix_raw$kpi <- "autre"
