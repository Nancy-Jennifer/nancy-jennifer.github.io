...
- KPI centré sur l’**expérience utilisateur** (temps de chargement perçu).  
- Sert à comparer les opérateurs sur la **fluidité de navigation**.
...
```{r data-env-plot, eval = !is.null(data_env_probe_map_v2), fig.cap="Performance internet mobile par zone, opérateur et contexte (si la granularité zone est disponible)."}
