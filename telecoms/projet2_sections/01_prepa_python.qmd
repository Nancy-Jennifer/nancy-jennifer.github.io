...
# Affichage convivial (évite l'impression de Path)
display(qa)
if qa["lignes"].sum() == 0:
    print("⚠️ Aucun fichier brut n’a encore été chargé — place-les dans data/raw/ puis relance le rendu pour obtenir des sorties non vides.")
```
...
- **9 fichiers nettoyés** + **2 sorties ITU FF** ciblées, prêts pour l’EDA R.  
- **QA journalisée**, **schéma YAML** exporté, et **lecture tolérante** aux variations d’encodage/séparateur.
